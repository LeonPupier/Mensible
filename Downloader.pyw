...
# Initialisation
window = Tk()
window.title('YouTube Downloader v1.2.0')
...
cadre2 = Frame(window)
cadre2.pack()
progress = Progressbar(cadre2, orient=HORIZONTAL, length=400, mode='determinate')
progress.pack(side=LEFT)

percent = StringVar()
percent.set("0%")
Label(cadre2, textvariable=percent).pack(side=RIGHT)
